...
def test_add_returns_valid_id():
    ...
    prj_id = entity_database.add(project)
...
def test_added_project_has_id_set():
    ...
    resistered_project = entity_database.get(prj_id)
...
def test_add_to_project_returns_valid_id(single_project, single_asset):
    ...
    asset_id = entity_database.add_to_project(single_asset, prj_id)
...
def test_added_asset_has_id_and_project_id_set(single_project, single_asset):
    ...
    resistered_asset = entity_database.get(asset_id)
...
def test_add_asset_or_shot_to_project(asset, single_project):
    project_id = entity_database.add(single_project)
    asset_id = entity_database.add_to_project(asset, project_id)
